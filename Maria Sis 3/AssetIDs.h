...
#define OBJECT_TYPE_RETURN_BOX 60
...
#define ID_SPRITE_KOOPAS_WALK_LEFT (ID_SPRITE_KOOPAS_WALK + 100)
#define ID_SPRITE_KOOPAS_WALK_RIGHT (ID_SPRITE_KOOPAS_WALK + 200)
#define ID_SPRITE_KOOPAS_DIE (ID_SPRITE_KOOPAS + 2000)
#define ID_SPRITE_KOOPAS_HYPER (ID_SPRITE_KOOPAS + 3000)
